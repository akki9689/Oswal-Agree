    ...
    <footer className="py-8 bg-light-green-200">
      <div className="container px-4 mx-auto text-justify md:px-6 lg:px-8">
        ...
        <div className="p-2 pt-4 mx-2 mt-8 text-center border-t border-dark-green-200 lg:mx-4">
          <div className="flex flex-wrap justify-center text-sm divide-x divide-dark-green-200 text-dark-green-100">
            {footerData.navigation1.map((item) => (
              <Link key={item.id} to={item.url} className="px-2 hover:text-dark-green-200">
                {item.label}
              </Link>
            ))}
          </div>
          <div className="flex flex-wrap justify-center mt-4 text-sm divide-x divide-dark-green-200 text-dark-green-100">
