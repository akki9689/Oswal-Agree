...
const CropFilter = () => {
  ...
  const filterData = () => {
    const filtered = allProducts.filter((product) => {
      ...
      return categoryMatch && cropMatch && pestMatch;
    });
        ...
        <div className="border-custom-border p-10 bg-filter-bg bg-top">
          <div className="flex flex-wrap gap-6 items-center py-20">
            ...
            >
              ...
              <option value="32">All Products</option>
              <option value="31">Bio Products</option>
              <option value="27">Fertilizer</option>
              <option value="25">Fungicide</option>
              <option value="24">Herbicide</option>
              <option value="29">Immunomodulator</option>
              <option value="23">Insecticide</option>
              <option value="26">Micronutrient Fertilizer</option>
              <option value="30">PGR (Plant Growth Regular)</option>
            </select>
